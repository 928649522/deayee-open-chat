...
<div class="gridBody">
    <table class="layui-hidden" id="appUserTable" lay-filter="appUserTable" style="height: 700px;"></table>
</div>
...
<script type="text/javascript" src="/resources/base/app/user/appUser.js"></script>
</body>
