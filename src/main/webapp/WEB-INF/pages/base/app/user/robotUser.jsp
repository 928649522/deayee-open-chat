...
<div class="x-body">
    ...
    <div class="gridBody">
        <table class="layui-hidden" id="robotUserTable" lay-filter="robotUserTable" style="height: 700px;"></table>
    </div>
</div>
...
<script type="text/javascript" src="/resources/base/app/user/robotUser.js"></script>
</body>
