...
<html>
  ...
  <div class="gridBody">
      <table class="layui-hidden" id="registerCodeTable" lay-filter="registerCodeTable"></table>
  </div>
...
<script type="text/javascript" src="/resources/base/common/js/superhao.js"></script>
  <script type="text/javascript" src="/resources/base/app/comm/registerCode.js"></script>
